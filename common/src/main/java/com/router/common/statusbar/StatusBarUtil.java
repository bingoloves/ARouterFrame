package com.router.common.statusbar;
...
public class StatusBarUtil {
    ...
    public static void setStatusBarPadding(View view) {
        setStatusBarPadding(view, getStatusBarHeight(view.getContext()));
    }
     ...
     * @param statusHeight
     */
    public static void setStatusBarPadding(View view, int statusHeight) {
        if (view != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                if (view != null) {
//                    Log.e("setStatusBarPadding","statusHeight = " + statusHeight);
//                    Log.e("setStatusBarPadding","PaddingTop = " + view.getPaddingTop());
//                    Log.e("setStatusBarPadding","PaddingLeft = "+view.getPaddingLeft());
//                    Log.e("setStatusBarPadding","PaddingRight = "+view.getPaddingRight());
//                    Log.e("setStatusBarPadding","PaddingBottom = "+view.getPaddingBottom());
