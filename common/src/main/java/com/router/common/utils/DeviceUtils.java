...
import com.router.common.PreferencesHelper;
...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    final String id =  PreferencesHelper.getClearCache().getString(KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId =  PreferencesHelper.getClearCache().getString(KEY_UDID, null);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        PreferencesHelper.getClearCache().put(KEY_UDID, udid);
        return udid;
    }
