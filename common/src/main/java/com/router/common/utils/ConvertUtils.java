...
import static com.router.common.utils.ImageUtils.isSpace;
...
public final class ConvertUtils {
    ...
    public static byte[] bitmap2Bytes(final Bitmap bitmap, final Bitmap.CompressFormat format, int quality) {
        return ConvertUtils.bitmap2Bytes(bitmap, format, quality);
    }
    ...
    public static byte[] drawable2Bytes(final Drawable drawable, final Bitmap.CompressFormat format, int quality) {
        return ConvertUtils.drawable2Bytes(drawable, format, quality);
    }
     ...
     * @return size of byte
     */
    public static long memorySize2Byte(final long memorySize, @TimeUnit final int unit) {
     ...
     */
    public static double byte2MemorySize(final long byteSize, @MemoryUnit final int unit) {
     ...
     * @return milliseconds
     */
    public static long timeSpan2Millis(final long timeSpan, @TimeUnit final int unit) {
     ...
     */
    public static long millis2TimeSpan(final long millis, @TimeUnit final int unit) {
        return millis / unit;
    }
