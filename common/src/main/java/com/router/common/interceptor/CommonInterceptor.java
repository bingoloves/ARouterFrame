...
/**
 * Created by bingo on 2020/8/28 0028.
 */
...
public class CommonInterceptor implements Interceptor {
    ...
    public synchronized Response intercept(Chain chain) throws IOException {
        ...
        try {
            ...
            XLog.e("response: " + sbJson.toString());
        } catch (Exception e) {
            e.printStackTrace();
...
//        saveCookies(response, request.url().toString());
     ...
     * @return
     */
    private Response getDefaultResponse(Response response){
        BaseResponse<String> bean = new BaseResponse<>();
        bean.setCode(200);
        bean.setMsg("请求异常");
        bean.setData("");
        Gson gson = new Gson();
        String responseJson = gson.toJson(bean);
        ResponseBody body = ResponseBody.create(MediaType.parse("application/json; charset=utf-8"), responseJson);
        response.body();
        return response;
    }
    ...
    private Request rebuildRequest(Request request) throws IOException {
        ...
        XLog.e("requestUrl: " + newRequest.url().toString());
        return newRequest;
    }
...
//                    multipartBodybuilder.addPart(part);
            ...
            try {
                ...
                XLog.e(getParamContent(newRequestBody));
