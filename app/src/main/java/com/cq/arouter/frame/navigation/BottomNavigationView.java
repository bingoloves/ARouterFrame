package com.cq.arouter.frame.navigation;
...
public class BottomNavigationView extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (coloredBackground) {
            itemActiveColorWithoutColoredBackground = ContextCompat.getColor(context, R.color.bnv_colorActive);
            itemInactiveColor = ContextCompat.getColor(context, R.color.bnv_colorInactive);
            ...
            if (itemActiveColorWithoutColoredBackground == -1)
                itemActiveColorWithoutColoredBackground = ContextCompat.getColor(context, R.color.bnv_itemActiveColorWithoutColoredBackground);
            itemInactiveColor = ContextCompat.getColor(context, R.color.bnv_withoutColoredBackground);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int white = ContextCompat.getColor(context, R.color.bnv_white);
        ...
        if (isTablet) {
            line.setBackgroundColor(ContextCompat.getColor(context, R.color.bnv_colorInactive));
